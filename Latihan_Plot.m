...
%%tugas mingdep membuat kodingan mengenai gambar grafik fungsi sebanyak
%%mungkin 3D 2D (histogram, boxplot, gambar semakin kompleks, atau kayak
%%batiknya bu hanna) buat yang sangat kompleks jika ingin nilai tinggi
